...
describe('Mood Database Storage', () => {
  ...
  describe('Retrieve Moods', () => {
    ...
    it('should get moods by date range', async () => {
      ...
      const moods = await usersRepository.getMoodsByDateRange(testUser._id.toString(), startDate, endDate)
  ...
  describe('Update Mood', () => {
    it('should update text content', async () => {
      ...
      const result = await usersRepository.updateMood(testUser._id.toString(), moodId, { textContent: 'Updated text' })
    ...
    it('should update rating', async () => {
      ...
      const result = await usersRepository.updateMood(testUser._id.toString(), moodId, { rating: 5 })
